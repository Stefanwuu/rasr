...
TF_CXXFLAGS += -I/usr/local/lib/python3.10/dist-packages/tensorflow/include
TF_LDFLAGS  += -Wl,--no-as-needed -Wl,--allow-multiple-definition
TF_LDFLAGS  += -lcrypto
# TF_LDFLAGS  += -L/usr/local/lib/python3.10/dist-packages/tensorflow/
TF_LDFLAGS  += -L/opt/apptek/thirdparty/usr/lib/
TF_LDFLAGS  += -Wl,-rpath -Wl,/opt/apptek/thirdparty/usr/lib/
